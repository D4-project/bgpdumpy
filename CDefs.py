...
#define AFI_IP 1
#define AFI_IP6 2
#define BGPDUMP_MAX_AFI 2  // Have to use a number.
// #else
// #define AFI_IP 1
...
#define BGPDUMP_MAX_SAFI 3  // Have to use a number.
...
struct mp_info {
  ...
  struct mp_nlri        *withdraw[3][4];  // Have to pass numbers
  struct mp_nlri        *announce[3][4];  // Have to pass numbers
};
...
class CConst:
    ...
    def nthval_macro(X, n):
        return X.val + (n)
    COM_NTHVAL = nthval_macro
